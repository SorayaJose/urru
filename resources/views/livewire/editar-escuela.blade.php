<form autocomplete="off" wire:submit.prevent='editarEscuela' class="w-full space-y-5">
    <div class="flex bg-white p-5  overflow-hidden shadow-sm sm:rounded-lg">
        <div class="w-1/4 pr-4 md:justify-left">
            <p class="font-medium text-red-800">Escuelas</p>
    ...
    <div class="flex bg-white p-5  overflow-hidden shadow-sm sm:rounded-lg">
        <div class="w-1/4 pr-4 md:justify-left">
            ...
            <p class="text-xs">Si se cambia el correo o la clave, la escuela no podrá ingresar. </p>
            <p class="text-xs">Dejar la clave vacia para no modificar la clave actual. </p>
        </div>
        <div class="w-3/4 md:justify-center">
            <div class="mb-2 pb-3">
