                    ...
                    @foreach ($bancos as $banco)
                        <tr>
                            ...
                            <td class="py-4 text-right">
                                <button onclick="window.location.href='{{ route('bancos.edit', $banco->id) }}'" 
                                ...
                                <button
                                    wire:click="$emit('prueba', {{ $banco->id }})" 
...
@push('scripts')
    ...
    <script>
        Livewire.on('prueba', bancoId => {
            Swal.fire({
                title: "¿Eliminar el banco?",
                text: "Un banco eliminado no se puede recuperar",
                icon: "warning",
            ...
            if (result.isConfirmed) {
                // eliminarla  el banco del  servidor
                Livewire.emit('eliminarBanco', bancoId)
                Swal.fire({
                    title: "Se elimino el banco",
