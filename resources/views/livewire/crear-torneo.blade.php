<form autocomplete="off" wire:submit.prevent='crearTorneo' class="w-full space-y-5" enctype="multipart/form-data">
    <div class="bg-white dark:bg-gray-800 p-4 sm:p-6 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="flex flex-col lg:flex-row lg:gap-6">
            ...
            <div class="lg:w-3/4">
                <div class="space-y-4">
                    <!-- Fecha y Nombre en grid responsive -->
                    ...
                    <div>
                        ...
                        @if ($imagen)
                            <div class="mt-3">
                                ...
                                <img src="{{ $imagen->temporaryUrl() }}" alt="Vista previa" class="w-full sm:w-64 h-auto rounded-lg border">
                            </div>
                        @endif
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                        <x-toggle model="cancion" label="¿Solicitar música?" />
                        <x-toggle model="cancion2" label="¿Solicitar música corta?" />
                        <x-toggle model="archivo" label="¿Solicitar coreografía?" />
                        <x-toggle model="archivo2" label="¿Solicitar coreografía corta?" />
                    </div>
