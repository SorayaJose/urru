<form wire:submit.prevent='crearSocio' class="w-full space-y-5">
    <div>
        <x-input-label for="persona" :value="__('Cédula de la Persona')" />
        <x-text-input id="persona" class="block mt-1 w-full" type="text" wire:model="persona" 
        :value="old('persona')" placeholder="Ingrese la cédula de la persona" />
