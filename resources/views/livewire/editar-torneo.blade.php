    ...
    <div class="flex bg-white p-5  overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="w-3/4 md:justify-center">
            ...
            <div class="mb-2 pb-3 form-group ">
                ...
                <div class="my-5 w-80">
                    @if ($imagen) 
                        {{-- Mostrar imagen temporal (recién subida) --}}
                        <img src="{{ $imagen->temporaryUrl() }}" alt="Vista previa" class="w-48 h-48 object-cover rounded shadow">
                    @elseif ($this->imagenDisco)
                        {{-- Mostrar imagen actual guardada en la base de datos --}}
                        <img src="{{ asset('storage/torneos/' . $this->imagenDisco) }}" alt="Imagen actual" class="w-48 h-48 object-cover rounded shadow">
                    @endif
                </div>
