            ...
            <div class="overflow-x-auto">
                <table class='mx-auto max-w-6xl w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300'>
                    <thead class="bg-gray-150">
                        ...
                        <th class="hidden lg:table-cell text-left text-red-800 font-semibold text-xs sm:text-sm uppercase px-3 sm:px-6 py-3 sm:py-4">
                            Descripción
                        </th>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4">
                                <div class="flex justify-center gap-2">
                                    <button 
                                        onclick="window.location.href='{{ route('pistas.edit', $pista->id) }}'" 
        ...
        @else
            @if ($readyToLoad)
                <div class="px-4 sm:px-8 py-6 sm:py-8 text-center text-gray-500">
                    ...
                    <p class="text-sm sm:text-base">No hay pistas para mostrar</p>
                </div>
            @else
    ...
    <script>
        Livewire.on('prueba', pistaId => {
            Swal.fire({
                ...
                confirmButtonText: "Sí, eliminar pista!",
